        ...
        <div className="flex flex-col gap-2 rounded-xl bg-amber-50/80 px-4 py-2 text-sm md:flex-row md:items-center md:justify-between">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <span className="max-w-xl text-slate-800">
              We&apos;re actively monitoring independent seniors in the Bay Area — including
              Rossmoor — to help shape Lares Health.
            </span>
          </div>
...
export default function HomePage() {
  return (
    <div className="space-y-16 md:space-y-20">
      ...
      {/* HERO */}
      <Container className="grid gap-10 py-10 md:grid-cols-[1.15fr,1fr] md:items-center">
        <div className="space-y-5">
          ...
          <p className="max-w-xl text-base md:text-lg text-slate-700">
            Lares Health watches for small changes in daily patterns so families don&apos;t
            have to. When something looks off, Lares nudges, checks in, and keeps everyone
            in the loop—without turning home into a hospital.
          </p>
          ...
          <p className="max-w-md text-sm md:text-base text-slate-500">
            ...
            with early-warning insights and gentle, human check-ins.
          </p>
        </div>
      ...
      {/* PILOT SECTION */}
      <Container id="pilot">
        <div className="space-y-6 rounded-3xl bg-amber-50 p-6 text-sm text-slate-900 ring-1 ring-amber-100 shadow-sm md:p-7">
          <div className="space-y-2">
            ...
            <p className="max-w-3xl text-sm md:text-base text-slate-900/90">
              We&apos;re starting with a small group of independent seniors in the Bay Area —
              including Rossmoor. These first families aren&apos;t just users; they help decide
              what &quot;useful&quot; looks like, and how Lares should show up day to day.
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <div className="space-y-2">
              ...
              <ul className="space-y-1.5">
                ...
                <li>No medical advice; we encourage you to talk to your doctor.</li>
                <li>No cameras in the living room or constant surveillance.</li>
              </ul>
            </div>
            <div className="space-y-2">
              <h3 className="text-sm font-semibold text-slate-900">
              ...
              <ul className="space-y-1.5">
                ...
                <li>
                  Families who are starting to worry a bit about falls, slowing down, or
                  subtle changes.
                </li>
                <li>
                  People willing to share practical feedback on what works and what
                  doesn&apos;t.
                </li>
              </ul>
            </div>
      ...
      <Container className="space-y-6">
        ...
        <div className="grid gap-4 text-sm text-slate-600 md:grid-cols-3">
          <Card className="p-4">
            ...
            <p>
              Days blur together. It&apos;s easy for loneliness, low mood, or reduced
              activity to build up quietly.
            </p>
          </Card>
          <Card className="p-4">
            <h3 className="mb-2 text-sm font-semibold text-slate-900">
            ...
            <p>
              Slower walks, restless sleep, skipped meals—each looks minor on its own but
              can signal real risk over time.
            </p>
          </Card>
          <Card className="p-4">
            <h3 className="mb-2 text-sm font-semibold text-slate-900">
            ...
            <p>
              Check-in calls help, but they&apos;re snapshots. Without data, families are
              guessing whether things are truly ok.
            </p>
          </Card>
        </div>
      </Container>
      ...
      <Container id="how-it-works" className="space-y-6">
        ...
        <div className="grid gap-4 text-sm text-slate-600 md:grid-cols-3">
          <Card className="flex flex-col gap-2 p-4">
            ...
            <ul className="space-y-1.5">
              <li>Connects to Apple Watch, iPhone, and compatible devices.</li>
          ...
          <Card className="flex flex-col gap-2 p-4">
            ...
            <ul className="space-y-1.5">
              <li>Learns what &quot;normal&quot; looks like for each person.</li>
              <li>Spots meaningful changes in activity, steadiness, or routines.</li>
            </ul>
          </Card>
          <Card className="flex flex-col gap-2 p-4">
            <div className="text-[0.7rem] font-medium uppercase tracking-[0.2em] text-sky-600">
            ...
            <ul className="space-y-1.5">
              <li>Sends clear, simple alerts to family when something looks off.</li>
              <li>Can trigger a gentle voice check-in to confirm how things are going.</li>
            </ul>
          </Card>
        </div>
      </Container>
      ...
      <Container className="space-y-6">
        ...
        <div className="grid gap-4 text-sm text-slate-600 md:grid-cols-4">
          <Card className="p-4">
            ...
            <p>
              Runs quietly in the background using signals from devices seniors already
              wear and use.
            </p>
          </Card>
          <Card className="p-4">
            ...
            <p>
              Highlights trends before they become emergencies: reduced movement, changes
              in steadiness, disrupted sleep, and more.
            </p>
          </Card>
          <Card className="p-4">
            <h3 className="mb-2 text-sm font-semibold text-slate-900">
            ...
            <p>
              A simple view of how things are going, with periodic summaries and timely
          ...
          <Card className="p-4">
            ...
            <p>
              Respectful, human language instead of clinical jargon—so seniors feel
      ...
      <Container className="space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-3 text-slate-700">
          ...
          <Card className="p-4">
            <p className="mb-2">
              &quot;I like that it&apos;s watching without hovering. I still decide what
              I do each day—it just notices if I start slowing down.&quot;
            </p>
            <p className="text-sm text-slate-500">
      ...
      <Container className="space-y-4 pb-10">
        ...
        <div className="max-w-3xl space-y-4 text-slate-700">
          <div>
            <h3 className="mb-1 font-semibold text-slate-900">Who is this pilot for?</h3>
            <p>
              Independent seniors living in the Bay Area who want to stay in control, and
              families who want clearer insight into day-to-day patterns without constant
              check-ins or devices everywhere.
            </p>
          </div>
          <div>
            ...
            <p>
              Lares works with iPhone, Apple Watch, and Apple Health–connected devices
              such as scales and blood pressure cuffs.
            </p>
          </div>
          <div>
            <h3 className="mb-1 font-semibold text-slate-900">
            ...
            <p>
              We focus on trends, not minute-by-minute tracking. Data is encrypted in
              transit and at rest, and we share only what families need to understand
              changes.
            </p>
          </div>
          <div>
            ...
            <p>
              Lares is not an emergency response or diagnostic service. It&apos;s an
              early-warning and peace-of-mind layer that helps families act sooner and
          ...
          <div>
            ...
            <p>
              Early families will receive preferred pricing and help shape the final
              plans. Our goal is a simple, predictable subscription that covers monitoring
              and family access.
            </p>
          </div>
        </div>
