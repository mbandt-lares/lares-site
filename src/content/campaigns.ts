...
export const campaigns: Record<string, CampaignPage> = {
  "fall-risk": {
    slug: "fall-risk",
    metaTitle: "Reduce fall risk with quiet, continuous monitoring | LaresCare",
    metaDescription:
      "LaresCare helps families spot early changes in balance, activity, and sleep—before a fall becomes a crisis.",
    heroEyebrow: "For families worried about falls",
    heroTitle: "Spot the small changes that often come before a fall.",
    heroSubtitle:
      "LaresCare watches how your parent’s movement and steadiness are changing over time, so you don’t have to wait for an emergency to know something is wrong.",
    ...
    proof: [
      {
        ...
        body: "LaresCare is designed around everyday life at home, not billing codes. It’s a quiet layer of awareness that helps you act sooner without overwhelming anyone with alarms.",
      },
      {
  ...
  "loneliness-checkins": {
    ...
    metaTitle: "Support an aging parent who feels alone | LaresCare",
    metaDescription:
      "LaresCare combines subtle activity signals with thoughtful check-ins to support elders who spend too much time alone.",
    heroEyebrow: "For families worried about loneliness",
    heroTitle: "When ‘I’m fine’ isn’t enough of an answer anymore.",
    heroSubtitle:
      "LaresCare helps you notice when your parent’s routines are getting quieter—fewer outings, less movement, more time alone—so you can step in with connection before it becomes a crisis.",
    heroImage: "/images/hero-elder-family.jpg",
