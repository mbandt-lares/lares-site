...
export const campaigns: Record<string, CampaignPage> = {
  "fall-risk": {
    slug: "fall-risk",
    metaTitle: "Reduce fall risk with quiet, continuous monitoring | Lares Health",
    metaDescription:
      "Lares Health helps families spot early changes in balance, activity, and sleep—before a fall becomes a crisis.",
    heroEyebrow: "For families worried about falls",
    heroTitle: "Spot the small changes that often come before a fall.",
    heroSubtitle:
      "Lares Health watches how your parent’s movement and steadiness are changing over time, so you don’t have to wait for an emergency to know something is wrong.",
  ...
  "loneliness-checkins": {
    ...
    metaTitle: "Support an aging parent who feels alone | Lares Health",
    metaDescription:
      "Lares Health combines subtle activity signals with thoughtful check-ins to support elders who spend too much time alone.",
